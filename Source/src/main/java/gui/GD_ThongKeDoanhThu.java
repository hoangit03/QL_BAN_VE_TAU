...
public class GD_ThongKeDoanhThu extends javax.swing.JPanel {
    ...
    private void jMonthChooser1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jMonthChooser1PropertyChange
		...
		for (int i = 1; i <= 31; i++) {
			dataset.setValue(((Long)veDao.layTongVeTrongNgay(jYearChooser1.getYear(), jMonthChooser1.getMonth()+1, i)).intValue(), "Tổng vé", i + "");
		}

		JFreeChart chart = ChartFactory.createBarChart("", "Tháng " + (jMonthChooser1.getMonth() + 1), "Số lượng vé đã bán", dataset, PlotOrientation.VERTICAL, false,
				true, false);
